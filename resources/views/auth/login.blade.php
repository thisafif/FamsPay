...
<x-layouts.guest>
    ...
    <div style="padding: 48px 40px;">
        ...
        <div style="text-align: center; margin-bottom: 36px;">
            <h1 style="font-size: 1.5rem; font-weight: 700; color: #1e293b; margin: 0 0 10px;">Masuk ke Akun</h1>
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            {{-- Email --}}
            <div style="display: flex; align-items: center; gap: 12px; background: #F1F5F9; border-radius: 16px; padding: 14px 16px; margin-bottom: 12px;">
            ...
            {{-- Password --}}
            <div style="display: flex; align-items: center; gap: 12px; background: #F1F5F9; border-radius: 16px; padding: 14px 16px; margin-bottom: 6px;">
                <svg style="width:20px;height:20px;color:#94a3b8;flex-shrink:0;" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <div style="text-align: right; margin-bottom: 20px;">
                <a href="#" style="font-size: 0.78rem; color: #94a3b8; text-decoration: none;">Lupa password?</a>
            </div>

            {{-- Tombol Masuk --}}
            <button type="submit"
                style="width:100%;background:#10B981;color:white;font-weight:700;font-size:0.9rem;padding:14px;border-radius:16px;border:none;cursor:pointer;font-family:inherit;transition:background 0.15s;"
